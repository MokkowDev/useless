...
import net.ccbluex.liquidbounce.features.module.modules.movement.wLongJump
...
class ModuleInfos : Element(300.0,100.0,1F, Side(Side.Horizontal.RIGHT,Side.Vertical.UP)) {
    ...
    override fun drawElement(): Border {
        ...
        val longjump = LiquidBounce.moduleManager.getModule(wLongJump::class.java) as wLongJump?
        if (longjump!!.state) {
