...
public class Slot
{
    ...
    public void draw(final int p_draw_1_, final int p_draw_2_, final float p_draw_3_, final float p_draw_4_) {
        ...
        RenderUtils.drawRoundedRect(p_draw_3_ + 23.0f, p_draw_4_ + 34.0f, p_draw_3_ + 45.0f, p_draw_4_ + 36.0f, realpha.reAlpha(-1118482, 0.2f), realpha.reAlpha(-1118482, 0.6f));
       Fonts.icon45.drawString(this.icon, p_draw_3_ + 23.0f, p_draw_4_ + 8.0f, realpha.reAlpha(Colors.WHITE.c, 0.85f));
        if (RenderUtils.isHovering(p_draw_1_, p_draw_2_, p_draw_3_, p_draw_4_, p_draw_3_ + 72.0f, p_draw_4_ + 40.0f)) {
            this.ishovered = true;
        }else {
            this.ishovered = false;
        }
