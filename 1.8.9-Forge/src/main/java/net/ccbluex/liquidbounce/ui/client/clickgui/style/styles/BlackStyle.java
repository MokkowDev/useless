...
public class BlackStyle extends Style {
    ...
    public void drawPanel(int mouseX, int mouseY, Panel panel) {
        ...
        float textWidth = Fonts.SFUI35.getStringWidth("§f" + StringUtils.stripControlCodes(panel.getName()));
        Fonts.SFUI35.drawString(panel.getName(), (int) (panel.getX() - (textWidth - 100.0F) / 2F), panel.getY() + 7 - 3, Color.WHITE.getRGB());
    }
    ...
    public void drawDescription(int mouseX, int mouseY, String text) {
        ...
        RenderUtils.drawBorderedRect(mouseX + 9, mouseY, mouseX + textWidth + 14, mouseY + Fonts.SFUI35.FONT_HEIGHT + 3, 3F, new Color(40,40,40).getRGB(), new Color(40,40,40).getRGB());
        GlStateManager.resetColor();
        Fonts.SFUI35.drawString(text, mouseX + 12, mouseY + (Fonts.SFUI35.FONT_HEIGHT / 2), Color.WHITE.getRGB());
    }
    ...
    public void drawButtonElement(int mouseX, int mouseY, ButtonElement buttonElement) {
        ...
        Fonts.SFUI35.drawString(buttonElement.getDisplayName(), buttonElement.getX() + 5, buttonElement.getY() + 5, Color.WHITE.getRGB());
    }
    ...
    public void drawModuleElement(int mouseX, int mouseY, ModuleElement moduleElement) {
        ...
        GlStateManager.resetColor();
        Fonts.SFUI35.drawString(moduleElement.getDisplayName(), moduleElement.getX() + 5, moduleElement.getY() + 5, Color.WHITE.getRGB());

        // Draw settings
        final List<Value<?>> moduleValues = moduleElement.getModule().getValues();

        if(!moduleValues.isEmpty()) {
            Fonts.SFUI35.drawString(">", moduleElement.getX() + moduleElement.getWidth() - 8, moduleElement.getY() + 5, Color.WHITE.getRGB());
            ...
            if(moduleElement.isShowSettings()) {
                ...
                for(final Value value : moduleValues) {
                    if(value instanceof BoolValue) {
                        ...
                        final float textWidth = Fonts.SFUI35.getStringWidth(text);
                        ...
                        Fonts.SFUI35.drawString(text, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 2, ((BoolValue) value).get() ? Color.WHITE.getRGB() : Integer.MAX_VALUE);
                        ...
                        Fonts.SFUI35.drawString(text, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 2, 0xffffff);
                        Fonts.SFUI35.drawString(listValue.openList ? "-" : "+", (int) (moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth() - (listValue.openList ? 5 : 6)), moduleElement.slowlySettingsYPos + 2, 0xffffff);

                        if(mouseX >= moduleElement.getX() + moduleElement.getWidth() + 4 && mouseX <= moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth() && mouseY >= moduleElement.slowlySettingsYPos && mouseY <= moduleElement.slowlySettingsYPos + Fonts.SFUI35.FONT_HEIGHT && Mouse.isButtonDown(0) && moduleElement.isntPressed()) {
                            listValue.openList = !listValue.openList;
                            mc.getSoundHandler().playSound(PositionedSoundRecord.create(new ResourceLocation("gui.button.press"), 1.0F));
                        }

                        moduleElement.slowlySettingsYPos += Fonts.SFUI35.FONT_HEIGHT + 1;
                        ...
                        for(final String valueOfList : listValue.getValues()) {
                            ...
                            if (listValue.openList) {
                                ...
                                GlStateManager.resetColor();
                                Fonts.SFUI35.drawString("> " + valueOfList, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 2, listValue.get() != null && listValue.get().equalsIgnoreCase(valueOfList) ? Color.WHITE.getRGB() : Integer.MAX_VALUE);
                                moduleElement.slowlySettingsYPos += Fonts.SFUI35.FONT_HEIGHT + 1;
                            }
                        }
                        ...
                        Fonts.SFUI35.drawString(text, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 3, 0xffffff);
                        ...
                        Fonts.SFUI35.drawString(displayString, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 2, Color.WHITE.getRGB());
                        ...
                        GlStateManager.resetColor();
                        Fonts.SFUI35.drawString(text, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 4, 0xffffff);
