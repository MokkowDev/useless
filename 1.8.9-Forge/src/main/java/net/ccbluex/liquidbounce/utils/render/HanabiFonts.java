...
public class HanabiFonts
{
	...
	static {
		HanabiFonts.ICON_CLICKGUI_RENDER = "�?";
		HanabiFonts.ICON_CLICKGUI_COMBAT = "�?";
		HanabiFonts.ICON_CLICKGUI_WORLD = "�?";
		HanabiFonts.ICON_CLICKGUI_MOVEMENT = "�?";
		HanabiFonts.ICON_CLICKGUI_PLAYER = "�?";
		HanabiFonts.ICON_CLICKGUI_GHOST = "�?";
		HanabiFonts.ICON_CLICKGUI_ARROW_UP = "�?";
		HanabiFonts.ICON_CLICKGUI_ARROW_DOWN = "�?";
		HanabiFonts.ICON_HANABI_LOGO = "4";
		HanabiFonts.ICON_MAINMENU_SINGLE = "\uE90A";
		HanabiFonts.ICON_MAINMENU_MULTI = "�?";
		HanabiFonts.ICON_MAINMENU_ALTMANAGER = "�?";
		HanabiFonts.ICON_MAINMENU_SETTINGS = "�?";
		HanabiFonts.ICON_MAINMENU_QUITGAME = "�?";
		HanabiFonts.ICON_NOTIFY_INFO = "�?";
		HanabiFonts.ICON_NOTIFY_SUCCESS = "�?";
		HanabiFonts.ICON_NOTIFY_WARN = "�?";
		HanabiFonts.ICON_NOTIFY_ERROR = "�?";
		HanabiFonts.ICON_PLAYER_REPEAT = "�?";
		HanabiFonts.ICON_PLAYER_NEXT = "�?";
		HanabiFonts.ICON_PLAYER_PLAY = "�?";
		HanabiFonts.ICON_PLAYER_PAUSE = "�?";
	}
}
