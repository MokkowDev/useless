 ...
 */
data class ConnectingEvent(val ip: String, val port: Int) : Event()
...
class MotionEven(var x: Double, var y: Double, var z: Double, var yaw: Float, var pitch: Float, var onGround: Boolean) : Event() {
