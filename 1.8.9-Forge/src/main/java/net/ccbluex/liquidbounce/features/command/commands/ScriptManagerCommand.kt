            ...
            when {
                args[1].equals("import", true) -> {
                    try {
                        ...
                        if (fileName.endsWith(".js")) {
                            ...
                            LiquidBounce.fileManager.loadConfig(
                                LiquidBounce.fileManager.clickGuiConfig)
                            ...
                            LiquidBounce.fileManager.loadConfig(
                                LiquidBounce.fileManager.clickGuiConfig)
                            LiquidBounce.fileManager.loadConfig(
                                LiquidBounce.fileManager.hudConfig)
                ...
                args[1].equals("reload", true) -> {
                    try {
                        ...
                        LiquidBounce.fileManager.loadConfig(
                            LiquidBounce.fileManager.modulesConfig)
                        LiquidBounce.isStarting = false
                        LiquidBounce.fileManager.loadConfig(
                            LiquidBounce.fileManager.valuesConfig)
                        LiquidBounce.clickGui = ClickGui()
                        LiquidBounce.fileManager.loadConfig(
                            LiquidBounce.fileManager.clickGuiConfig)
