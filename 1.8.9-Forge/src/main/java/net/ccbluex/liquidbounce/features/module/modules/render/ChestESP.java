...
@ModuleInfo(name = "ChestESP", description = "Rise", category = ModuleCategory.RENDER)
public final class ChestESP extends Module {
    ...
    private void render(final int amount, final TileEntity p) {
        ...
        RenderUtils.lineNoGl(-50, offset, 50, offset, new Color(ClickGUI.colorRedValue.get(),ClickGUI.colorGreenValue.get(),ClickGUI.colorBlueValue.get()));
        RenderUtils.lineNoGl(-50, -95 + offset, -50, offset,  new Color(ClickGUI.colorRedValue.get(),ClickGUI.colorGreenValue.get(),ClickGUI.colorBlueValue.get()));
        RenderUtils.lineNoGl(-50, -95 + offset, 50, -95 + offset,  new Color(ClickGUI.colorRedValue.get(),ClickGUI.colorGreenValue.get(),ClickGUI.colorBlueValue.get()));
        RenderUtils.lineNoGl(50, -95 + offset, 50, offset,  new Color(ClickGUI.colorRedValue.get(),ClickGUI.colorGreenValue.get(),ClickGUI.colorBlueValue.get()));
