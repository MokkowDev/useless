...
public class HighJump extends Module {
    private final   FloatValue motionValue = new FloatValue("HYTMotion", 5f, 0.1f, 8f);
    private final FloatValue heightValue = new FloatValue("Height", 2F, 1.1F, 5F);
    private final ListValue modeValue = new ListValue("Mode", new String[] {"Vanilla","HYT","Damage", "AACv3", "DAC", "Mineplex"}, "Vanilla");
    ...
    public void onUpdate(final UpdateEvent event) {
        ...
        switch(modeValue.get().toLowerCase()) {
            case "damage":
                ...
                break;
            case "hyt":
                mc.thePlayer.motionY = (motionValue.get()).doubleValue();
