...
@ModuleInfo(name = "Breadcrumbs", category = ModuleCategory.RENDER, description = "skid")
class Breadcrumbs : Module() {
    private val typeValue = ListValue("Type", arrayOf("Line", "Rect", "Sphere"), "Line")
    public val colorRedValue = IntegerValue("R", 255, 0, 255)
    public val colorGreenValue = IntegerValue("G", 255, 0, 255)
    public val colorBlueValue = IntegerValue("B", 255, 0, 255)
    public val colorAlphaValue = IntegerValue("Alpha", 255, 0, 255)
    public val colorRainbowValue = BoolValue("Rainbow", false)
    ...
    private val lineWidthValue = IntegerValue("LineWidth", 1, 1, 10)
    private val sphereScaleValue = FloatValue("SphereScale", 1f, 0.1f, 2f)
