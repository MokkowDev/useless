...
@ModuleInfo(name = "Radar", description = "skid.", category = ModuleCategory.RENDER)
...
//        RenderUtil.rectangleBordered((double)(xOffset + 3.0f), (double)(yOffset + 3.0f), (double)(xOffset + (float)size1 - 3.0f), (double)(yOffset + (float)size1 - 3.0f), (double)0.5, (int)Colors2.getColor((int)27), (int)Colors2.getColor((int)61));
        RenderUtil.rectangleBordered((double)(xOffset + 3.0f), (double)(yOffset + 3.0f), (double)(xOffset + (float)size1 - 3.0f), (double)(yOffset + (float)size1 - 3.0f), (double)0.5, new Color(0,0,0,150).getRGB(), new Color(0,0,0,150).getRGB());
        RenderUtil.drawGradientSideways((double)(xOffset + 3.0f), (double)(yOffset + 2.6f), (double)(xOffset + (float)(size1 / 2)), (double)((double)yOffset + 3.0), (int)color1, (int)color2);
        RenderUtil.drawGradientSideways((double)(xOffset + (float)(size1 / 2)), (double)(yOffset + 2.6f), (double)(xOffset + (float)size1 - 3.0f), (double)((double)yOffset + 3.0), (int)color2, (int)color3);
        ...
        for (Object o : mc.theWorld.getLoadedEntityList()) {
            ...
            RenderUtil.rectangleBordered((double)((double)(xOffset + 4 + (float)(size1 / 2) + rotX) - 1.5), (double)((double)(yOffset + 4 + (float)(size1 / 2) + rotY) - 1.5), (double)((double)(xOffset + 4 + (float)(size1 / 2) + rotX) + 1.5), (double)((double)(yOffset + 4 + (float)(size1 / 2) + rotY) + 1.5), (double)0.5, (int)color, (int)Colors2.getColor((int)46));
        }
    }
