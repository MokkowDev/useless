    ...
    private void move() {
        switch (modeValue.get().toLowerCase()) {
            ...
            case "constantmotion":
                ...
                break;
            case "hypixel":{
                if (mc.thePlayer.posY != mc.thePlayer.posY + 1
                        && mc.thePlayer.movementInput.jump) { // if Scaffolded to UP
                    mc.thePlayer.setPosition(mc.thePlayer.posX, mc.thePlayer.posY + 2,
                            mc.thePlayer.posZ);
                    mc.thePlayer.motionY = 0;
