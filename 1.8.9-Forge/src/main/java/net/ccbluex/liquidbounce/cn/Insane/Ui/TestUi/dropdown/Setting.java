...
/*
            case SELECTBOX:
                ...
                Fonts.SF.SF_18.SF_18.drawString(displayName, module.tab.getPosX() + 49.5 - Fonts.SF.SF_18.SF_18.stringWidth(displayName) / 2, y + 5.5f, Color.WHITE.getRGB(), true);
                ...
                if (opened) {
                    ...
                    for (String value : setting.getSelectBoxProperty().getAcceptableValues()) {
                        ...
                        Fonts.SF.SF_18.SF_18.drawString(value, module.tab.getPosX() + 15, (float) (yS + 6), rgb, true);
                        Fonts.SF.SF_26.SF_26.drawString(".", module.tab.getPosX() + 9, yS, setting.getSelectBox().contains(value) ? 0xffffffff : new Color(174, 174, 174, 150).getRGB());
                        yS += 17;
                    }
                }
