...
import net.ccbluex.liquidbounce.cn.Insane.newdropdown.utils.normal.TimerUtil;
      ...
      //  }
       ...
       //     configPanel.rawY = y;
        ...
        DrRenderUtils.drawGradientRectSideways2(sr.getScaledWidth() - 40, 0, 40, sr.getScaledHeight(),
                DrRenderUtils.applyOpacity(ClickGUI.generateColor().getRGB(), 0),
                DrRenderUtils.applyOpacity(ClickGUI.generateColor().getRGB(), (float) (.4 * moveOverGradientAnimation.getOutput())));
