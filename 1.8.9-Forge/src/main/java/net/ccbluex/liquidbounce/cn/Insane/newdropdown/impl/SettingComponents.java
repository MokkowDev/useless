package net.ccbluex.liquidbounce.cn.Insane.newdropdown.impl;
...
import net.ccbluex.liquidbounce.cn.Insane.newdropdown.utils.animations.impl.EaseInOutQuad;
import net.ccbluex.liquidbounce.cn.Insane.newdropdown.utils.normal.Main;
import net.ccbluex.liquidbounce.cn.Insane.newdropdown.utils.objects.PasswordField;
import net.ccbluex.liquidbounce.cn.Insane.newdropdown.utils.render.DrRenderUtils;
import net.ccbluex.liquidbounce.cn.Insane.newdropdown.utils.render.GuiEvents;
...
public class SettingComponents extends Component {
    ...
    public void handle(int mouseX, int mouseY, int button, GuiEvents type) {
        ...
        boolean accent = ClickGUI.colormode.get().equalsIgnoreCase("Color");
